...
import { RiShieldKeyholeLine } from "react-icons/ri"; // Secure Knowledge
import { LuBot } from "react-icons/lu"; // Agent Automation
import { HiOutlineChatBubbleOvalLeft } from "react-icons/hi2"; // Conversational AI
            ...
            <main className="main-wrapper relative overflow-hidden">
                ...
                <section id="section-breadcrumb">
                    ...
                    <div className="breadcrumb-wrapper relative overflow-hidden">
                        <div className="overflow-hidden absolute w-full h-full top-0 z-0  ">
                            <Image
                                src="/assets/images/trycybo/bg.webp"
                                alt="about-hero-image"
                                width={1296}
                                height={650}
                                className="h-full w-full object-cover filter blur-[1px]   opacity-[0.5]   object-bottom z-0"
                            />
                        </div>
                    ...
                    <div className="pt-28 lg:pt-40 xl:pt-[120px]">
                        <div className="global-container">
                            <div className="grid items-center gap-10 md:grid-cols-2 xl:grid-cols-[minmax(0,_1.3fr)_1fr]">
                                <div>
                                    <h2 className="font-raleway tracking-wide text-5xl md:text-6xl lg:text-7xl xl:text-[72px]">
                                ...
                                <div className="jos flex flex-col gap-6 md:gap-10">
                                    <div className="overflow-hidden rounded-[10px]">
                                        <Image
                                            src="/assets/images/trycybo/i1.webp"
                                            alt="trycybo-hero"
                                            width={900}
                                            height={540}
                    ...
                    <div className="pb-20 pt-20 xl:pb-[120px]">
                        <div className="global-container">
                            <div className="jos mx-auto mb-10 text-center md:max-w-xl lg:max-w-3xl">
                                <h2 className="font-raleway tracking-wide text-4xl font-medium">What TryCybo does</h2>
                            ...
                            <ul className="grid gap-x-6 gap-y-12 md:grid-cols-3">
                                <li className="text-center jos" data-jos_delay="0.1">
                                    <div className="mx-auto mb-[20px] inline-flex h-10 w-auto justify-center">
                                        ...
                                        <HiOutlineChatBubbleOvalLeft size={60} className="text-coloBrandBlue" />
                                    </div>
                                    <h3 className="mb-3 font-raleway tracking-wide   text-2xl font-bold">Conversational AI</h3>
                                ...
                                <li className="text-center jos" data-jos_delay="0.2">
                                    <div className="mx-auto mb-[20px] inline-flex h-10 w-auto justify-center">
                                        ...
                                        <LuBot size={60} className="text-coloBrandBlue" />
                                    </div>
                                    <h3 className="mb-3 font-raleway tracking-wide   text-2xl font-bold">Agent Automation</h3>
                                ...
                                <li className="text-center jos" data-jos_delay="0.3">
                                    <div className="mx-auto mb-[20px] inline-flex h-10 w-auto justify-center">
                                        ...
                                        <RiShieldKeyholeLine size={60} className="text-coloBrandBlue" />
                                    </div>
                                    <h3 className="mb-3 font-raleway tracking-wide   text-2xl font-bold">Secure Knowledge</h3>
                            ...
                            <div className="global-container">
                                <div className="grid items-center gap-10 md:grid-cols-2">
                                    <div className="jos" data-jos_animation="fade-left">
                                        <div className="overflow-hidden rounded-[10px]">
                                            <Image src="/assets/images/trycybo/i2.webp" alt="demo" width={526} height={450} />
                                        </div>
                                    </div>

                                    <div className="jos" data-jos_animation="fade-right">
                                        <h2 className="mb-6 font-raleway tracking-wide text-4xl font-medium">How TryCybo works</h2>
                    ...
                    <div className="bg-black">
                        <div className="py-16 sm:px-10 md:px-20 xl:px-[100px] xl:py-[80px]">
                            <div className="global-container text-center">
                                <h2 className="font-raleway tracking-wide  text-4xl font-medium text-white">Start your TryCybo Pilot</h2>
                ...
                <section id="trycybo-testimonials">
                    <div className="bg-[#EDEDE0] px-5 sm:px-[50px]">
                        <div className="relative z-[1] mt-20 mx-auto max-w-full rounded-[20px] bg-[#381FD1]">
                            <div className="py-16 sm:px-10 md:px-20 lg:py-20 xl:px-[100px] xl:py-[130px]">
                                <div className="global-container">
                                    <div className="jos mb-10 text-center">
                                        <h2 className="font-raleway tracking-wide text-4xl   font-medium text-white">What customers say</h2>
                                    </div>
                                    ...
                                    <ul className="grid gap-x-10 gap-y-8 md:grid-cols-2">
                                        <li className="jos flex flex-col gap-y-6 text-white" data-jos_delay="0.1">
                                            ...
                                            <p className="font-raleway tracking-wide text-lg font-bold">
                                                TryCybo reduced our ticket backlog and delighted customers with faster answers. A game-changer for support. 
                                            </p>
                                        ...
                                        <li className="jos flex flex-col gap-y-6 text-white" data-jos_delay="0.2">
                                            ...
                                            <p className="font-raleway tracking-wide text-lg font-bold">
                                                Integrating TryCybo into our CRM automated 40% of manual tasks. Our team can now focus on high-impact work. 
                                            </p>
                ...
                <section id="trycybo-faq">
                    <div className="pb-20 pt-20 xl:pb-[120px]">
                        <div className="global-container">
                            <div className="jos mx-auto mb-10 text-center md:max-w-xl lg:max-w-3xl">
                                <h2 className="font-raleway tracking-wide text-4xl font-medium">TryCybo — FAQ</h2>
                            </div>
                ...
                <section id="trycybo-contact">
                    <div className="bg-black">
                        <div className="py-16 xl:py-[80px]">
                            <div className="global-container text-center">
                                <h2 className="font-raleway tracking-wide text-4xl font-medium text-white">Ready to deploy an agent?</h2>
