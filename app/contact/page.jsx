										...
										<ul className="mt-12 flex flex-col gap-y-8 lg:gap-y-12">
											<li className="flex flex-col gap-y-4 text-2xl font-bold">
												...
												<Link
													...
													className="text-2xl font-normal leading-loose hover:text-colorCyanBlue lg:text-3xl"
												>
													info@favdevs.com
												</Link>
											</li>
												...
												<ul className="mt-auto flex gap-x-[15px]">
													<li>
														<Link
															...
															className="group relative flex h-[30px] w-[30px] items-center justify-center rounded-[50%] bg-black hover:bg-colorCyanBlue"
														>
															<Image
																src="/assets/images/th-1/facebook-icon-white.svg"
																alt="facebook"
																width={14}
																height={14}
															...
															/>
															<Image
																src="/assets/images/th-1/facebook-icon-black.svg"
																alt="facebook"
																width={14}
																height={14}
													...
													<li>
														...
														>
															<Image
																src="/assets/images/th-1/twitter-icon-white.svg"
																alt="twitter"
																width={14}
																height={14}
																className="opacity-100 group-hover:opacity-0"
															/>
															<Image
																src="/assets/images/th-1/twitter-icon-black.svg"
																alt="twitter"
																width={14}
																height={14}
																className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100"
													...
													<li>
														...
														>
															<Image
																src="/assets/images/th-1/linkedin-icon-white.svg"
																alt="linkedin"
																width={14}
																height={14}
																className="opacity-100 group-hover:opacity-0"
															/>
															<Image
																src="/assets/images/th-1/linkedin-icon-black.svg"
																alt="linkedin"
																width={14}
																height={14}
																className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100"
													...
													<li>
														...
														>
															<Image
																src="/assets/images/th-1/instagram-icon-white.svg"
																alt="instagram"
																width={14}
																height={14}
																className="opacity-100 group-hover:opacity-0"
															/>
															<Image
																src="/assets/images/th-1/instagram-icon-black.svg"
																alt="instagram"
																width={14}
																height={14}
																className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100"
										...
										<div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
											...
											<div className="flex flex-col gap-y-[10px]">
												...
												<input
													...
													className="rounded-[10px] border border-gray-300 bg-white px-6 py-[18px] font-bold text-black outline-none transition-all placeholder:text-slate-500 focus:border-colorCyanBlue"
													required=""
												/>
											</div>
											{/* Form Single Input */}
										...
										<div className="grid grid-cols-1 gap-6">
											...
											<div className="flex flex-col gap-y-[10px]">
												...
												<textarea
													...
													id="contact-message"
													className="min-h-[180px] rounded-[10px] border border-gray-300 bg-white px-6 py-[18px] font-bold text-black outline-none transition-all placeholder:text-slate-500 focus:border-colorCyanBlue"
					...
					<div className="bg-black pb-40 pt-20 xl:pb-[200px] xl:pt-[130px]">
						...
						<div className="global-container">
							...
							<div className="relative">
								<Image
									src="/assets/images/th-1/mapbase.svg"
									width={100}
									height={100}
									alt="mapbase"
								...
								<div className="group absolute hidden sm:flex gap-2 sm:top-[10%] sm:left-[13%]">
									<div className="relative w-[50px] h-[50px]">
										<button className="group flex justify-center items-center w-[50px] h-[50px] relative transition-all duration-300">
											<Image
												src="/assets/images/th-1/icon-gray-location-marker.svg"
											...
											/>
											<Image
												src="/assets/images/th-1/icon-orange-location-marker.svg"
												alt="icon-gray-location-marker"
												width={50}
												height={50}
										...
										<div className="absolute bg-white rounded-[8px] p-4 text-sm w-[170px] bottom-0 right-0 xl:right-[50px] xxl:right-auto xxl:left-[50px] opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-300 xl:translate-y-12 group-hover:translate-y-0">
											<div className="flex gap-1 font-bold pb-3">
												<Image
													src="/assets/images/th-1/icon-black-location-marker.svg"
